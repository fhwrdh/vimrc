...
let s:N1   = [ '#00005f' , '#dfff00' , 246 , 234 ]
let s:N2   = [ '#ffffff' , '#444444' , 244 , 236 ]
let s:N3   = [ '#9cffd3' , '#202020' , 246 , 238 ]
...
"        \ 'airline_c': [ '#ffffff' , '#5f005f' , 11     , 238      , ''     ] ,
"        \ }

let s:I1 = [ '#00005f' , '#00dfff' , 232 , 24  ]
let s:I2 = [ '#ffffff' , '#005fff' , 244 , 236  ]
let s:I3 = [ '#ffffff' , '#000080' , 246 , 238  ]
...
let s:V1 = [ '#000000' , '#ffaf00' , 232 ,  71 ]
let s:V2 = [ '#000000' , '#ff5f00' , 244 , 236 ]
let s:V3 = [ '#ffffff' , '#5f0000' , 246 , 238 ]
...
"   finish
" endif
" let g:airline#themes#fhwrdh#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
